...
def test_claustrum_segmenter():
    ...
    pred_image = concrete_strategy_b.perform_segmentation()
    concrete_strategy_b.save_segmentation(mask=pred_image, outputDir='/Users/rita/Uni/pmsd/Claustrum_Demo_GitHub/output')